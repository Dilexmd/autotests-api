...
class GetServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetUser = channel.unary_unary(
                '/userservice.GetService/GetUser',
...
def add_GetServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'userservice.GetService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('userservice.GetService', rpc_method_handlers)
