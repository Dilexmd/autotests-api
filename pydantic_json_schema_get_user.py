...
get_user_data_response = private_users_client.get_user_api(user_id)
get_user_data_response_schema = GetUserResponseSchema.model_json_schema()

validate_json_schema(instance=get_user_data_response.json(),schema=get_user_data_response_schema)